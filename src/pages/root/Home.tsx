  ...
  return (
    <>
            ...
            <AnimatedSection animationType="scale" delay={300} duration={500}>
              <div className="flex flex-col items-center justify-center -mt-1 sm:-mt-2 md:-mt-4 lg:-mt-6 space-y-2 sm:space-y-3 md:space-y-6 lg:space-y-8">
                <img
                  ...
                  className="w-[120px] sm:w-[180px] md:w-[250px] lg:w-[300px] h-auto object-contain transform transition-transform duration-300 hover:scale-105"
                />
                <span className="text-lg sm:text-2xl md:text-4xl lg:text-5xl font-bold text-[#0D1E40] tracking-wide leading-none">
                  {COMPANY_INFO.name}
                </span>
              </div>
            </AnimatedSection>
      ...
      <section className="py-12 sm:py-16 md:py-20 relative overflow-hidden">
        ...
        <div className="container mx-auto px-3 sm:px-4 md:px-6 lg:px-8 text-center relative">
